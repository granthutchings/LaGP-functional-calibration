...
Now we add a periodic angle bias to the experimental data. In this first plot we show the new experimental data without noise, then in the next plot we show the noisy versions. We can see that the angle bias should not be too hard to model, as its a simple periodic function. We will add slightly less noise with $\sigma_y=.05$.
